...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  ...
  head: ({ loaderData }) => {
    ...
    const metadata: OGMetaTags = {
      title: 'GroupFlux',
      description:
        'A farmer group lending platform for the Kenyan market connecting farmers, group leaders, lenders, and investors with M-Pesa integration and trust score analytics.',
      image: ogImageUrl,
